...
export default function ProjectCard({
  ...
  return (
    <div className="rounded-xl overflow-hidden border border-slate-200/70 bg-slate-900/20 backdrop-blur-sm transition duration-300 hover:opacity-95 hover:scale-[1.01]">
      ...
      <div className="flex items-center gap-4 p-4 border-t border-slate-200/70 bg-slate-950/40">
        <Link
          ...
          className="inline-flex items-center gap-2 text-slate-200 transition hover:opacity-80"
        >
        ...
        {liveUrl && (
          <Link
            href={liveUrl}
            target={isLiveExternal ? '_blank' : '_self'}
